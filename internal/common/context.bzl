...
# load("@rules_nodejs//internal/common:node_module_info.bzl", "NodeModuleInfo", "collect_node_modules_aspect")
# load("@rules_nodejs//internal/common:module_mappings.bzl", "get_module_mappings", "module_mappings_runtime_aspect")
...
# The NodeModuleInfo is provided by the rules_nodejs and generated by the
# collect_node_modules_aspect when the target has a "tags" attribute with
# "NODE_MODULE_MARKER" in it.
# NodeModuleInfo = provider(
#   fields = {
# Only the workspace is needed because rules_
